      ...
      <div class="modal-content">
        ...
        <div class="audit-section">
          ...
          <div class="audit-grid">
            ...
            <div class="audit-item"><label>审核时间：</label><span>{{ formatDateTime(record.level1_review_time) }}</span>
            </div>
          ...
          <div class="audit-grid">
            ...
            <div class="audit-item"><label>审核时间：</label><span>{{ formatDateTime(record.level2_review_time) }}</span>
            </div>
...
.info-section h4, .audit-section h4 {
  font-size: 1.1rem;
  font-weight: 600;
...
.status-badge.approved {
  background: linear-gradient(90deg, #44e0b1, #2aa95c);
  color: #fff;
}

.status-badge.rejected {
  background: linear-gradient(90deg, #f3adbd, #c04a5d);
  color: #fff;
}

.status-badge.pending {
  background: linear-gradient(90deg, #c7cfea, #ae75e5);
  color: #fff;
}
