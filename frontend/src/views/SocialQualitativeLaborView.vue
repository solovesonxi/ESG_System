<template>
  <div class="shared-form" @selection-changed="fetchData">
    <form>
      <BaseInfoSelector :review="review" form-type="social_qual_labor" @selection-changed="fetchData"/>
...
const fetchData = async () => {
  try {
    const response = await apiClient.get('/analytical/social_qualitative_labor', {
