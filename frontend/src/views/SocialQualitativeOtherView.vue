<template>
  <div class="shared-form">
    <form>
      <BaseInfoSelector :review="review" form-type="social_qual_other" @selection-changed="fetchData"/>
...
const fetchData = async () => {
  try {
    const response = await apiClient.get('/analytical/social_qualitative_other', {
